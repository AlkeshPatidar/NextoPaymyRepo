...
const TrackingScreen = ({ navigation, route }) => {
    ...
    const trackingData = route?.params?.trackingData || {
        ...
        lastLocation: '07-Dec 23:44, Bhagan Toll Plaza',
        route: [
            { id: 1, name: 'Panipat', time: 'Reaching on 10-Dec 00:12', status: 'On time', type: 'destination' },
            { id: 2, name: 'Ochadi', time: '07-Dec 07:05', type: 'checkpoint' },
            { id: 3, name: 'Nayagaon', time: '07-Dec 05:35', type: 'checkpoint' },
            { id: 4, name: 'Piplyamandi', time: '07-Dec 04:12', type: 'checkpoint' },
            { id: 5, name: 'Bhiwandi', time: 'Loaded on 06-Dec 23:00', type: 'origin' }
        ]
    };
    ...
    const styles = StyleSheet.create({
        ...
        timelineLine: {
            width: 2,
            flex: 1,
            backgroundColor: App_Primary_color + '40',
            marginTop: 4,
        },
        timelineDot: {
            width: 12,
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.mapContainer}>
                    <Image
                        source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSC52U-Qyk1jL5ibkQOQVMxnXjGNnhrJ-yIwA&s' }}
                        style={styles.mapPlaceholder}
                    />
                    <TouchableOpacity style={styles.shareButton}>
                        <MaterialCommunityIcons name="share-variant" size={20} color={App_Primary_color} />
                    </TouchableOpacity>
                </View>
