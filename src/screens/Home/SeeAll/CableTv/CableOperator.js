...
const CableProvider = ({ navigation, route }) => {
 ...
 const providers = [
    {
        id: '1',
        name: 'Tata Sky',
        logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjGvhKLj8fVZqQxK0YqVqLqYqJ5YqLqYqLqA&s',
        type: 'popular',
    },
    {
        id: '2',
    ...
    const renderProviderItem = (item) => (
        <TouchableOpacity
            ...
            onPress={() => {
                ...
                navigation.navigate('CableEnterscreen', { providerName: item.name });
            }}
        >
            <Image
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <Text style={styles.headerTitle}>Select Cable Tv</Text>
                    <TouchableOpacity
