...
const EnterSubscriptionDetail = ({ navigation, route }) => {
    ...
    const handleConfirm = () => {
        if (subscriberId.trim()) {
            ...
            navigation.navigate('BroadbandViewBill', {
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.infoCard}>
                        <Text style={styles.infoText}>
                           Please Note: your Subscription pack will be activated on the mobile number you’ve entered. After you make the payment, you use this mobile number to log in and enjoy the services on the MX player app/ website.          </Text>
                    </View>
                </View>
            </ScrollView>
...
export default EnterSubscriptionDetail;