...
const EnterInsuranceDetail = ({ navigation, route }) => {
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.inputCard}>
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Loan Policy Number"
                    ...
                    <View style={styles.infoCard}>
                        <Text style={styles.infoText}>
                      Nextopay’s terms of services apply to all bill payments.         </Text>
                    </View>
                </View>
            </ScrollView>
...
export default EnterInsuranceDetail;