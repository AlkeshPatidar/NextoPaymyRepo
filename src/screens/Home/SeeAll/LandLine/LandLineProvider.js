...
const LandLineProvider = ({ navigation, route }) => {
    ...
    const providers = [
        ...
        {
            id: '5',
            name: 'Connect landline',
            logo: 'https://cdn-icons-png.flaticon.com/512/7749/7749544.png',
            type: 'popular',
        },
        {
            id: '6',
            name: 'Hathway landline/Dataone - Corporate',
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <Text style={styles.headerTitle}>LandLine</Text>
                    <TouchableOpacity
