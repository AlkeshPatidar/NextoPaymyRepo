...
const PipedGasProvider = ({ navigation, route }) => {
  ...
  const providers = [
        {
            id: '1',
            name: 'Adani Gas',
            logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvX5YgP9rPQqN8LK8f9pVN0KJuOQKxzYLqYQ&s',
            type: 'popular',
        },
        {
            id: '2',
            name: 'Bhagyanagar Gas Limited',
            logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKxK1UkCejtru9tXvnk1WuzMXjW-wx-F8yHw&s',
            type: 'popular',
    ...
    const renderProviderItem = (item) => (
        <TouchableOpacity
            ...
            onPress={() => {
                ...
                navigation.navigate('ViewGasBill', { providerName: item.name });
            }}
        >
            <Image
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <Text style={styles.headerTitle}>Select Gas Provider</Text>
                    <TouchableOpacity
...
export default PipedGasProvider;